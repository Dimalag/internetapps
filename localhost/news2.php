				...
				<div class="col-lg-8">
					<div class="single-article-section">
						<div class="single-article-text">
							...
							<h2>Прощание с Java. Зачем?</h2>
							<p>Комментарий основного разработчика:</p>
							<p>"Потому что буду использовать проект кучу раз, и тут системное программирование, больше подходят плюсы. В плюсах больше плюсов. чем в джаве.". Пунктуация сохранена.</p>
						</div>
					</div>
				</div>
			</div>
